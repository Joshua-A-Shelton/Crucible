...
DELEGATE(Crucible.Core.Transform, void, _transformAddTransforms_ptr, cs_TransformAddTransforms, crucible::core::Transform& transform1, crucible::core::Transform& transform2, crucible::core::Transform& out)\
